...
tags = ['howto', 'osx']
cover = 'micromv-header.png'
aliases = ['/micromv-on-osx-in-2018/']
+++

![micromv-header-image](micromv-header.png)
...
![Opening an app from an unidentified developer](micromv-warning-screenshot.png)
...
![Window showing Tape Control as the selected option](micromv-recording-mode-screenshot.png)
