...
tags = ['howto', 'osx']
cover = 'micromv-header.webp'
slug = 'micromv-on-os-x-in-2018'
aliases = ['/micromv-on-osx-in-2018/']
+++

![micromv-header-image](micromv-header.webp)
...
![Opening an app from an unidentified developer](micromv-warning-screenshot.webp)
...
![AVCVideoCap app window with device listed](micromv-device-list.png)
...
![Capture file creation window](micromv-capture-screenshot.png)
...
![Window showing Tape Control as the selected option](micromv-recording-mode-screenshot.webp)
